...
Thread.sleep(1000);
driver.findElement(By.id("ap_email")).sendKeys("er.mohinichavan@gmail.com");
Thread.sleep(1000);
...
Thread.sleep(1000);
driver.findElement(By.className("a-input-text")).sendKeys("Mohini Chavan");
Thread.sleep(1000);
driver.findElement(By.id("ap_phone_number")).sendKeys("9763910985");
driver.findElement(By.name("secondaryLoginClaim")).sendKeys("er.mohinichavan@gmail.com");

driver.findElement(By.id("ap_password")).sendKeys("Mohi@1234");
...
driver.findElement(By.name("reg_passwd__")).sendKeys("Mohi@1234");
